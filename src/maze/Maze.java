...
public class Maze {
	...
	/**
	 * Change the display of the maze so that it will print the path found from start to goal.
	 * 
	 * NOTE: This method could use redesigning so that it did not expose the MazeNode class to the outside world.
	 * 
